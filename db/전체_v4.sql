-- --------------------------------------------------------
-- 호스트:                          codingmaker.net
-- 서버 버전:                        11.4.10-MariaDB - MariaDB Server
-- 서버 OS:                        Win64
...
-- nsl02 데이터베이스 구조 내보내기
DROP DATABASE IF EXISTS `nsl02`;
CREATE DATABASE IF NOT EXISTS `nsl02` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;
USE `nsl02`;

-- 테이블 nsl02.activity 구조 내보내기
...
-- 테이블 데이터 nsl02.activity:~99 rows (대략적) 내보내기
...
-- 테이블 데이터 nsl02.category:~6 rows (대략적) 내보내기
...
-- 테이블 데이터 nsl02.exec_log:~2 rows (대략적) 내보내기
DELETE FROM `exec_log`;
INSERT INTO `exec_log` (`log_id`, `recommendation_id`, `executed_at`) VALUES
	(4, 1, '2026-05-14 17:34:03'),
	(5, 3, '2026-05-14 17:39:31');

-- 테이블 nsl02.offlineactivity 구조 내보내기
...
CREATE TABLE IF NOT EXISTS `offlineactivity` (
  ...
  `activity_place_type` enum('INDOOR','OUTDOOR') NOT NULL COMMENT '실내/실외 활동 구분',
  PRIMARY KEY (`activity_id`),
  CONSTRAINT `offlineactivity_ibfk_1` FOREIGN KEY (`activity_id`) REFERENCES `activity` (`activity_id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;

-- 테이블 데이터 nsl02.offlineactivity:~71 rows (대략적) 내보내기
DELETE FROM `offlineactivity`;
INSERT INTO `offlineactivity` (`activity_id`, `location`, `activity_place_type`) VALUES
	(1, '집', 'INDOOR'),
	(2, '실내', 'INDOOR'),
	(9, '실내', 'INDOOR'),
	(10, '집', 'INDOOR'),
	(11, '실내', 'INDOOR'),
	(12, '집', 'INDOOR'),
	(13, '근처 카페 또는 집', 'INDOOR'),
	(14, '실내', 'INDOOR'),
	(15, '집', 'INDOOR'),
	(16, '근처 헬스장', 'INDOOR'),
	(17, '근처 헬스장', 'INDOOR'),
	(18, '근처 공원/산책로', 'OUTDOOR'),
	(19, '집 근처 동네', 'OUTDOOR'),
	(21, '요가원 또는 집', 'INDOOR'),
	(22, '필라테스 센터', 'INDOOR'),
	(23, '실내 수영장', 'INDOOR'),
	(24, '자전거 도로/공원', 'OUTDOOR'),
	(25, '근교 산', 'OUTDOOR'),
	(26, '배드민턴장/공원', 'OUTDOOR'),
	(27, '볼링장', 'INDOOR'),
	(28, '클라이밍 센터', 'INDOOR'),
	...
	(96, '호텔', 'INDOOR'),
	(97, '캠핑장', 'OUTDOOR'),
	(98, '어두운 야외/루프탑', 'OUTDOOR'),
	(99, '야경 명소/전망대', 'OUTDOOR');

-- 테이블 nsl02.onlineactivity 구조 내보내기
...
-- 테이블 데이터 nsl02.onlineactivity:~28 rows (대략적) 내보내기
...
-- 테이블 nsl02.recommendation 구조 내보내기
...
-- 테이블 데이터 nsl02.recommendation:~3 rows (대략적) 내보내기
DELETE FROM `recommendation`;
INSERT INTO `recommendation` (`recommendation_id`, `user_id`, `activity_id`, `weather`, `user_condition`, `recommended_at`) VALUES
	(1, 'test2', 68, '맑음', 'good', '2026-05-14 17:00:08'),
	(2, 'test2', 28, '맑음', '하', '2026-05-14 17:25:44'),
	(3, 'test2', 13, '맑음', '상', '2026-05-14 17:39:31');

-- 테이블 nsl02.rejection_log 구조 내보내기
...
-- 테이블 데이터 nsl02.rejection_log:~0 rows (대략적) 내보내기
DELETE FROM `rejection_log`;

-- 테이블 nsl02.user 구조 내보내기
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  `preferred_type` enum('ONLINE','OFFLINE','BOTH') NOT NULL DEFAULT 'BOTH' COMMENT '온라인/오프라인 활동 선호 유형',
  PRIMARY KEY (`user_id`),
  UNIQUE KEY `email` (`email`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_uca1400_ai_ci;

-- 테이블 데이터 nsl02.user:~10 rows (대략적) 내보내기
DELETE FROM `user`;
INSERT INTO `user` (`user_id`, `password`, `name`, `email`, `preferred_type`) VALUES
	('asdfasdf', '3124123', 'anweknv', 'a24124@gmail.com', 'BOTH'),
	('sksj817', '1983725', 'alkwofn', 'akandkxn@gmail.com', 'BOTH'),
	('string', 'string', 'string', 'string', 'BOTH'),
	('test_developer_01', 'securePassword123!', '개발자', 'developer01@example.com', 'BOTH'),
	('test1', '1234', 'testtest', 'test@gmail.com', 'BOTH'),
	('test2', '12345', 'asdfadsfaa', 'ajeknf@gmail.com', 'BOTH'),
	('test3', '123456', 'sdaf', 'asdfawef@gmail.com', 'BOTH'),
	('testuser01', 'securePass123', '홍길동', 'hong@test.com', 'BOTH'),
	('wibbw9', '92776', 'hjqijb', 'ijqj2b@gmail.com', 'BOTH'),
	('순천대', 'tnscjseo', '아아', 'djgjhj@vnjut.com', 'BOTH');

-- 테이블 nsl02.usergoal 구조 내보내기
...
-- 테이블 데이터 nsl02.usergoal:~10 rows (대략적) 내보내기
DELETE FROM `usergoal`;
INSERT INTO `usergoal` (`goal_id`, `user_id`, `current_goal`, `created_at`) VALUES
	(3, 'test1', '자기계발', '2026-05-14 15:28:50'),
	(4, 'test2', '자기계발', '2026-05-14 16:46:12'),
	(5, 'test3', '자기계발', '2026-05-16 03:32:52'),
	(6, 'testuser01', '운동 습관 만들기', '2026-05-19 14:10:30'),
	(7, 'string', 'string', '2026-05-24 23:00:00'),
	(8, 'test_developer_01', '자기계발', '2026-05-27 01:47:04'),
	(9, 'asdfasdf', '자기계발', '2026-05-27 02:41:00'),
	(10, 'sksj817', '자기계발', '2026-05-27 02:45:32'),
	(11, 'wibbw9', '자기계발', '2026-05-27 10:44:16'),
	(12, '순천대', '번아웃', '2026-05-27 11:17:23');

-- 테이블 nsl02.usersatisfaction 구조 내보내기
...
-- 테이블 데이터 nsl02.usersatisfaction:~1 rows (대략적) 내보내기
DELETE FROM `usersatisfaction`;
INSERT INTO `usersatisfaction` (`satisfaction_id`, `user_id`, `category_id`, `satisfaction_score`) VALUES
	(1, 'test2', 1, 4);
